...
factor
    : LEFT_PAR expression RIGHT_PAR |  LITERAL (((LEFT_SBRACKET (expression) RIGHT_SBRACKET) (LEFT_SBRACKET (expression) RIGHT_SBRACKET)?)?) | funcCall | VAR_INT | VAR_FLOAT | VAR_BOOL | VAR_STRING;
